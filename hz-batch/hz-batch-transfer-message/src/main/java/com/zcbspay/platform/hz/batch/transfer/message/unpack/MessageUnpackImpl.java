...
public class MessageUnpackImpl implements MessageUnpack {
	...
	private MessageBean createDLD032(String message, MessageHead messageHead) throws IOException {
		...
		while (1==1) {
			...
			System.out.println(new String(singlebillBytes,"GBK"));
	...
	public static void main(String[] args) {
		...
		String msg = "DLD03208331010010233100620912017051111024500000000013310062091201705110120170511113240000000013310062091201705110310016833101103016228480018543668976           郭佳                                                        3310130601213582310310001               RMB0000000001000000000             000         3                                201705111713310062091201705110310016933101103016228480018543668976           郭佳                                                        3310130601213582310310001               RMB0000000001000000000             000         3                                201705111713310062091201705100310016733101103016228480018543668976           gj                                                          3310130601213582310310001               RMB0000000001000000000             000         3                                201705114913310062091201705110310017033101103016228480018543668976           郭佳                                                        3310130601213582310310001               RMB0000000001000000000             000         3                                20170511491";
		...
		for(CollectBillBean billBean : bean.getBillDetaList()){
			System.out.println(JSON.toJSON(billBean));
		}
